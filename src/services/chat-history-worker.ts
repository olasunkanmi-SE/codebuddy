...
export class ChatHistoryWorker {
  ...
  private async getChatHistory(agentId: string): Promise<any[]> {
    return new Promise((resolve, reject) => {
      try {
        // Simulate async operation to prevent blocking
        setTimeout(() => {
          try {
      ...
      try {
        ...
        setTimeout(() => {
          try {
            ...
            reject(
              new Error(
                `Failed to save chat history: ${error instanceof Error ? error.message : String(error)}`,
              ),
            );
          }
        }, 0);
      ...
      try {
        ...
        setTimeout(() => {
          try {
            ...
            reject(
              new Error(
                `Failed to add chat message: ${error instanceof Error ? error.message : String(error)}`,
              ),
            );
          }
        }, 0);
      ...
      try {
        ...
        setTimeout(() => {
          try {
            ...
            reject(
              new Error(
                `Failed to get recent chat history: ${error instanceof Error ? error.message : String(error)}`,
              ),
            );
          }
        }, 0);
      ...
      try {
        ...
        setTimeout(() => {
          try {
            ...
            reject(
              new Error(
                `Failed to cleanup old chat history: ${error instanceof Error ? error.message : String(error)}`,
              ),
            );
          }
        }, 0);
