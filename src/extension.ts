...
import { APP_CONFIG, COMMON, generativeAiModel, OLA_ACTIONS, USER_MESSAGE } from "./constant";
...
const { geminiKey, geminiModel, groqKey, groqModel, anthropicApiKey, anthropicModel } = APP_CONFIG;
