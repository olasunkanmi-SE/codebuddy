...
export const SettingsIcon: React.FC<SettingsIconProps> = ({ name, size = 16 }) => {
  const icons: Record<string, React.ReactNode> = {
    ...
    flask: (
      <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M9 3h6"></path>
        <path d="M10 3v6.5L4.5 18a2 2 0 0 0 1.72 3h11.56a2 2 0 0 0 1.72-3L14 9.5V3"></path>
        <path d="M8 14h8"></path>
      </svg>
    ),
    info: (
...
// Settings gear icon for the main UI toggle button
export const SettingsGearIcon: React.FC<{ size?: number; className?: string }> = ({ size = 20, className }) => (
  <svg
